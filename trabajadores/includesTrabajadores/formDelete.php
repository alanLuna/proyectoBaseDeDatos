...
<div id="divEliminar<?= $valor; ?>" class="container col-md-12 col-lg-12 col-xs-12 col-sm-12" style="display:none">  
    <select id="delete<?= $valor?>" class="form-control">
        <option selected="true" disabled="disabled">Selecciona un trabajador: </option>
    </select>
    <form id="formEliminar<?= $valor; ?>" class="form-horizontal" method="post" autocomplete="off" style="display:none;">
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input class="form-control" type="text" name="deleterfc<?= $valor ?>" id="deleterfc<?= $valor ?>"
                placeholder="Ingrese las nuevas rfc del trabajador" required autocomplete="off">  
            </div>
        </div>
        <div class="form-group">
