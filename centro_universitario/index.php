<!DOCTYPE html>
<?php
    $consulta = "centro universitario";
    $valor="CentroUniversitario";
?>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <div class="am-wrapper am-fixed-sidebar">
      ...
      <div class="container col-md-6 col-md-offset-4 col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-lg-6 col-lg-offset-4" style="margin-top:10px;">
          ...
          <div class="container col-md-8 col-xs-12 col-lg-8 col-sm-12">
            ...
            <?php include('includesCentroUniversitario/formRegistro.php');  ?>
            <?php include('includesCentroUniversitario/formCambios.php');  ?>
            <?php include('includesCentroUniversitario/formDelete.php');  ?>
            <?php include('includesCentroUniversitario/formConsulta.php');  ?>
          </div>
      </div>
...
<script type="text/javascript">
    var arrayCentroUniversitario = <?php echo json_encode($json); ?>;
    /*cambio 1*/
    var opciones = "";
